...
name=factor,
description={A vector that stores categorical data. Each category within a factor is called a \gls{level}. R Documentation: \R{?factor}}
}
...
%W-----------------------------------
\newglossaryentry{wide data}{
name=wide data,
description={Data which spreads variables across multiple columns.}
}
