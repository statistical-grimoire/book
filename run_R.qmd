...
When you do update R, be aware that packages (add-ons that extend R's functionality, which we will cover later) are often tied to specific versions of R. After updating, you may need to reinstall or update your packages. Don't worry, this is a normal part of the process, and we will walk through package management in a later chapter.
