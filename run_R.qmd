...
If you follow the default setup, you do not need to uninstall the previous version. In fact, it is usually preferable not to, as RStudio and Positron will both allow you to easily switch between installed versions on your computer.
