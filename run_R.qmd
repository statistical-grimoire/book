...
To determine the code name just run `lsb_release -cs` in the terminal. This will print your Ubuntu version's codename. Now, in the code below, replace `resolute` with the codename of your version of Ubuntu:

```bash
echo "deb https://cloud.r-project.org/bin/linux/ubuntu resolute-cran40/" \
...
## Installing an IDE (RStudio and Positron) {#sec-ide_install}
