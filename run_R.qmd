...
For Debian, Ubuntu, Linux Mint, and other Debian/Ubuntu-based distributions, download the `.deb` file. Once downloaded, you can double-click it to install using your system's software installer, or use the terminal method described in @sec-linux_RStudio for a more reliable installation.
...
### Upgrading on Windows and MacOS
