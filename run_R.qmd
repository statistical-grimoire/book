...
![The MS-DOS Prompt application in Windows 95 is an example of a terminal window. This allowed users to access the DOS command line which was the foundation of the Windows operating system.](imgs/run_R/win_95_MS_DOS_terminal.png){width=100% #fig-win95_MS_DOS fig-alt="MS-DOS Prompt application in Windows 95"} 
