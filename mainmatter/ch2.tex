...
The easiest way to understand how \textit{ggplot2} works is to simply dive in an use it. Along the way, we will also learn a little bit more about R and data manipulation. However, a disclaimer is perhaps useful here:
