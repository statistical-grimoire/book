...
The principal answer to this question has to do with flexibility. There is simply not always a single correct way to do things.  Different sets of data come with their own unique intricacies and problems which are often not amenable to the prescriptive analyses the aforementioned programs employ. Which is not to say that a program like SPSS, for instance, is incapable of adapting to these scenarios. It usually is, but this adaptation often requires the user to pay for some additional feature they did not get in their original purchase or it demands a much higher level of expertise with the software than most users are ever likely to acquire - expecting them to learn some obscure programming language, specific to that software, that all but a privileged few actually comprehend. In contrast, R offers an intuitive and rewarding experience for most users. At first glance, R may appear intimidating, but it operates in a straightforward and logical manner, much like a calculator. Moreover, many users will find learning it significantly easier than they initially anticipated. This accessibility is thanks, in large measure, to the extensive network of online resources created and nurtured by R's vibrant and passionate community over the years. They see R as something worthwhile to support and develop - often at their own personal time and expense. Proprietary software like SPSS has no equivalent to this, nor will it ever. Users are often snared within its ecosystem not out of preference or love for the software, but because it is all they have ever known.
