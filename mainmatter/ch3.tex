...
\noindent
One thing that is not apparent from the 10 row output is that all of the numeric columns contain some missing, \R{NA}, values. This is why the \R{na.rm = TRUE} needed to be specified.
...
\begin{outR}
predynastic     c4800BC     c4200BC     c4000BC     c3500BC 
   1320.142    1348.831    1434.375    1494.700    1336.663 
   
    c2780BC     c1590BC      c378BC      c331BC     c3700BC 
   1308.454    1347.488    1285.781    1318.642    1356.429 
\end{outR}
